...
#define PLAY 16 //boton play
#define PAUSE 20 //boton pause
#define STOP 21 //boton stop
#define VERDE 13 //salida del play
#define BLANCO 19 //salida del pause
#define ROJO 26 //salida del stop
